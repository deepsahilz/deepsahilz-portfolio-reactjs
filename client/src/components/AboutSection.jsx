    ...
    <section className='font-neue w-full bg-zinc-200 min-h-screen text-zinc-800'>
      <div className='mx-auto px-5 md:px-10 py-20 md:py-32'>
        <div className='flex flex-col xl:flex-row justify-between gap-8 md:gap-30 items-start'>
          ...
          <div className='space-y-5 md:space-y-8'>
            ...
            <div className='flex flex-wrap gap-2.5'>
              {tags.map((item, idx) => (
                <span
                  key={idx}
                  className='py-1 md:py-2 px-3 md:px-5 rounded-full border-1 border-zinc-700 text-sm md:text-base font-medium transition-all hover:bg-zinc-800 hover:text-zinc-100 cursor-default'
                >
                  {item}
                </span>
              ))}
          ...
          {/* Right Column - Bio */}
          <div className='space-y-6 text-justify text-base md:text-xl lg:text-2xl text-zinc-700 leading-relaxed'>
            <p>
